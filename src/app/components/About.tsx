    ...
    <section id="about" className="py-32 bg-gray-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-12 relative z-10">
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="group relative p-6 rounded-2xl bg-gray-900/50 border border-gray-800 backdrop-blur-sm hover:border-gray-700 transition-all"
            >
          ...
          {expertise.map((item, index) => (
            ...
            >
              ...
              <div className="relative h-full p-8 rounded-2xl bg-gray-900 border border-gray-800 group-hover:border-transparent transition-all">
                ...
                <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${item.gradient} flex items-center justify-center mb-6 shadow-lg ${item.shadowColor} group-hover:scale-110 transition-transform`}>
        ...
        >
          ...
          <div className="relative rounded-3xl bg-gray-900/80 backdrop-blur-xl border border-gray-800 overflow-hidden">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {['React', 'Node.js', 'TypeScript', 'Figma', 'AWS', 'Docker', 'PostgreSQL', 'MongoDB', 'Next.js'].map((tech, index) => (
                      <motion.div
                        ...
                        className="px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-center text-sm text-gray-300 hover:border-purple-500/50 hover:bg-purple-500/10 transition-all cursor-default"
                      >
                        {tech}
                      </motion.div>
                    ))}
